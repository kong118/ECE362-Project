...
//     pwm_set_clkdiv(slice, clock_get_hz(clk_sys) / 1000000);
...
//         angle = 0;
//     }
//     float pulse_length = 1000 + (angle/180.0)*(1000);//usual hobbby servos have a max of 2ms puls ead a min of 1ms pulse
